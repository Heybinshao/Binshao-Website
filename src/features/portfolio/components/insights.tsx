  ...
  return (
    <Panel id={ID} className="screen-line-bottom-none">
      ...
      <figure>
        ...
        <figcaption className="pointer-events-none absolute right-2 bottom-2 bg-background text-xs leading-none text-zinc-400 select-none sm:right-4 dark:text-zinc-700">
          FIG_002
        </figcaption>
      </figure>
    </Panel>
