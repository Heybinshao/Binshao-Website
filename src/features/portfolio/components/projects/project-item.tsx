  ...
  return (
    <Collapsible className={className} defaultOpen={project.isExpanded}>
      <div className="flex items-center hover:bg-accent-muted">
        {project.logo ? (
          <Image
            ...
            height={48}
            quality={100}
            className="mx-4 flex size-10 shrink-0 rounded-xl ring-1 ring-black/10 select-none dark:ring-white/15"
            unoptimized
            aria-hidden
          />
        ) : (
      ...
      <CollapsibleContent className="group overflow-hidden duration-300 data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
        <div className="space-y-4 border-t border-edge p-4 shadow-inner group-data-[state=closed]:animate-fade-out group-data-[state=open]:animate-fade-in">
          {project.description && (
            <Prose>
